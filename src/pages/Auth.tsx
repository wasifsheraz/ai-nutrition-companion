  ...
  return (
    <div className="min-h-[100dvh] flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center w-1/2 p-12 relative overflow-hidden">
        ...
        <FloatingBlob className="w-[400px] h-[400px] bg-primary top-1/3 left-1/2 -translate-x-1/2" delay={1} />
        ...
        >
          <motion.h1
            ...
            className="text-4xl font-display font-bold gradient-text-shimmer"
          >
            NutriAI
          </motion.h1>
          <motion.p
            ...
            {["AI-powered food recognition", "Personalized meal planning", "Smart fridge management"].map((f, i) => (
              ...
              >
                <motion.div
                  ...
                  className="w-6 h-6 rounded-full bg-primary/12 flex items-center justify-center"
                >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <AnimatePresence mode="wait">
              <motion.div
                key={tab}
                initial={{ opacity: 0, x: tab === "login" ? -12 : 12, filter: "blur(4px)" }}
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="btn-secondary w-full py-3 text-sm font-medium">
            Google
          </motion.button>
